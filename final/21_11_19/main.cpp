...
int main(int argc, char* argv[]){
    ...
    if(BT > QT){
        printf("Bubble Sort: Quick Sort 가 %.0f 빠름", BT / QT);
    }
    else{
        printf("Bubble Sort: Quick Sort가  %.0f 느림", QT / BT);
    }
	printf("\n");
    if(MT > QT){
        printf("Merge Sort: Quick Sort  가 %.0f 빠름", MT / QT);
    }
    else{
        printf("Merge Sort: Quick Sort가  %.0f 느림", QT / MT);
    }
	printf("\n");
    if(ST > QT){
        printf("STL Sort: Quick Sort  가 %.0f 빠름", ST / QT);
    }
    else{
        printf("STL Sort: Quick Sort가  %.0f 느림", QT / ST);
    }
    printf("\n");
    return 0;
}
